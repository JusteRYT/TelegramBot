/**
 * Concrete wizard for Dungeons & Dragons announcements.
 * @extends AbstractCreationWizard
 */
class DndCreationWizard extends AbstractCreationWizard {
    process() {
    ...
    _handleDescription() {
        ...
        this.client.sendMessage(this.chatId, "✨ <b>Анонс D&D опубликован!</b>", { message_thread_id: this.threadId, parse_mode: 'HTML' });
    }
}